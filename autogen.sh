...
function print_usage() {
    ...
    echo "  -l, --add-langvar   Add env. variable \$GTLANG_spa to login script."
...
# the current dir:
if   test x${GTLANG_spa} = x ; then
	echo "WARNING: The variable \${GTLANG_spa} has not been defined. You"
	...
	echo "$0 -l"
	echo
elif test x${GTLANG_spa} != x${LANGDIR} ; then
	echo "WARNING: The variable \${GTLANG_spa} has the value:"
	echo "  ${GTLANG_spa}"
