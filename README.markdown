...
This directory contains source files for the Spanish language morphology
...
-   <http://giellatekno.uit.no/spadoc/index.html>
-   <https://giellalt.uit.no/tools/docu-spa-manual.html>
...
The Spanish language sources can be acquired using [giella SVN
