...
[![Maturity](https://github.com/giellalt/lang-spa-x-ext-apertium/raw/generated/docs-data/fst-maturity.svg)](https://giellalt.github.io/MaturityClassification.html)
![Lemma count](https://github.com/giellalt/lang-spa-x-ext-apertium/raw/generated/docs-data/fst-lemmacount.svg)
[![Speller suggestion quality](https://github.com/giellalt/lang-spa-x-ext-apertium/raw/generated/docs-data/speller-suggestions.svg)](https://giellalt.github.io/lang-spa-x-ext-apertium/typosreport/)
...
[![Doc build](https://img.shields.io/github/actions/workflow/status/giellalt/lang-spa-x-ext-apertium/docs.yml?logo=github&label=DocCI)](https://github.com/giellalt/lang-spa-x-ext-apertium/actions/workflows/docs.yml)
[![Build Status](https://builds.giellalt.org/api/badge/lang-spa-x-ext-apertium?logo=buildkite&label=CoreCI)](https://builds.giellalt.org/pipelines/lang-spa-x-ext-apertium/builds/latest)

Download nightly / CI/CD installation packages for testing (contains the core zhfst file(s)):

[![Windows](https://img.shields.io/badge/download%40latest-Windows--bhfst-brightgreen)](https://pahkat.uit.no/main/download/speller-spa?platform=windows&channel=nightly)
[![MacOS](https://img.shields.io/badge/download%40latest-macOS--bhfst-brightgreen)](https://pahkat.uit.no/main/download/speller-spa?platform=macos&channel=nightly)
[![Mobile](https://img.shields.io/badge/download%40latest-mobile--bhfst-brightgreen)](https://pahkat.uit.no/main/download/speller-spa?platform=mobile&channel=nightly)
